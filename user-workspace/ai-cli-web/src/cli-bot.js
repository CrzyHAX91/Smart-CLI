...
class CliBot {
    ...
    async performActions() {
        try {
            ...
            // Generate text with Llama to keep LLM service active
            await this.llamaService.generateText('Keep CLI active');
            
            // Generate text with OpenAI to keep API active
            await this.openAIService.generateText('Maintain CLI connection');
